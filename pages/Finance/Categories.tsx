...
const CategoryTable: React.FC<CategoryTableProps> = ({ 
  ...
  subItemInputs, onSubItemInputChange, onAddSubItem, onDeleteSubItem, loadingAction
}) => {
...
const FinanceCategories: React.FC = () => {
  ...
  const handleDeleteCategory = async (id: string) => {
    if (!confirm('Bu kategoriyi ve altındaki tüm alt kalemleri silmek istediğinize emin misiniz?')) return;
