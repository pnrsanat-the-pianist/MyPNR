...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  // Specific Admin Login Handler - TEST MODE (Bypass Auth)
  const handleTestAdminLogin = () => {
    // Direkt admin olarak giriş yap (test amaçlı)
    console.log('🔓 Test Admin Girişi - Şifresiz');
    onLogin(UserRole.ADMIN);
    window.location.hash = '/';
  };
      ...
      <div className="w-full max-w-md bg-white dark:bg-pnr-card border border-slate-200 dark:border-slate-800 rounded-3xl p-8 shadow-2xl relative z-10 animate-in fade-in zoom-in-95 duration-300 my-8">
        ...
        <div className="mt-6 pt-6 border-t border-slate-100 dark:border-slate-800">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
            {/* ADMIN BUTTON - TEST MODE (NO PASSWORD) */}
            <button
              ...
              title="Test Admin Girişi (Şifresiz)"
            >
